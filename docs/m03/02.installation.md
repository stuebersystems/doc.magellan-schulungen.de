...
--|--
**Server** |Der Datenbank-Server (Firebird) und alle weiteren Module werden auf einem Server installiert. Auf diesen befindet sich im Regelfall die MAGELLAN 8 Datenbank. Die einzelnen Arbeitsstationen, welche auf den Server zugreifen, werden mit der Art `Arbeitsplatz` installiert.
...
|Betriebssystem | Pfad|
|--| --|
|Windows 10| C:\Programme\Stueber Systems\MAGELLAN 8  |
...
Betriebssystem | Pfad
--------------------| -------------
Windows 10| C:\Users\Public\Documents\Stueber Systems\MAGELLAN 8\Datenbank\Magellan8.fdb
...
--------------------| -------------
Windows 10| C:\Users\Public\Documents\Stueber Systems\MAGELLAN 8\Datenbank\Magellan8.fdb
Windows Server 2003 | C:\ProgramData\Documents\Stueber Systems\MAGELLAN 8\Datenbank\Magellan8.fdb
Windows Server 2008 | C:\ProgramData\Documents\Stueber Systems\MAGELLAN 8\Datenbank\Magellan8.fdb
...
Bitte schauen Sie den Abschnitt ["Probleme bei der Installation?"](https://doc.magellan6.stueber.de/installation/probleme-bei-der-installation) an!
...
Über Neuerungen im Programm informieren wir im Abschnitt [Was ist neu?](http://doc.magellan.stueber.de/changelog/changelog)
